...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("/Users/aruzhan/Desktop/lab-8/racer/Enemy.png")
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound('/Users/aruzhan/Desktop/lab-8/racer/Lab8_Racer_crash.wav').play()
        time.sleep(1)
